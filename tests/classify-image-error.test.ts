...
describe('classifyImageError — auth failures', () => {
  it('classifies a 401 error as provider_down, blocking', () => {
    ...
    const c = classifyImageError(err)
...
describe('classifyImageError — 429 rate limits', () => {
  ...
  // The Google provider (and its RESOURCE_EXHAUSTED special case) was removed
  // in BUG-7 — its free-tier image quota is permanently 0.
  it('does NOT treat a RESOURCE_EXHAUSTED 429 as provider_down', () => {
